...
namespace CapaDatos
{
    public class DatosProfesor
    {
        ...
        //Constructor
        public DatosProfesor(int idprofesor, string nombre, string apellido, string telefono, string direccion, string cedula, string genero, string condicionmedica, DateTime fechanacimiento, DateTime fechaingreso, string correo, string nacionalidad, string titulo, string estatus, int idcurso, string textobuscar)
        {
        ...
        //Metodos Insertar
        public string Insertar(DatosProfesor Profesor)
        {
            string Respuesta = "";
            ...
            try
            {
                ...
                Command.CommandText = "spinsertar_profesor";
                ...
                ParametroIdProfesor.Direction = ParameterDirection.Output;
                ...
                ParametroNombre.Value = Profesor.Nombre;
                ...
                ParametroApellido.Value = Profesor.Apellido;
                ...
                ParametroTelefono.Value = Profesor.Telefono;
                ...
                ParametroDireccion.Value = Profesor.Direccion;
                ...
                ParametroCedula.Value = Profesor.Cedula;
                ...
                ParametroGenero.Value = Profesor.Genero;
                ...
                ParametroCondicionMedica.Value = Profesor.Condicion_Medica;
                ...
                ParametroFechaNacimiento.Value = Profesor.Fecha_Nacimiento;
                ...
                ParametroFechaIngreso.Value = Profesor.Fecha_Ingreso;
                ...
                ParametroCorreoElectronico.Value = Profesor.Correo_Electronico;
                ...
                ParametroNacionalidad.Value = Profesor.Nacionalidad;
                ...
                ParametroTitulo.Value = Profesor.Titulo;
                ...
                ParametroEstatus.Value = Profesor.Estatus;
                ...
                ParametroIdCurso.Value = Profesor.IdCurso;
            ...
            {
                Respuesta = ex.Message + ex.StackTrace + " Insertar CapaDatos Profesor."; 
            }
            finally
            {
        ...
        //Metodos Editar
        public string Editar(DatosProfesor Profesor)
        {
            string Respuesta = "";
            SqlConnection SqlCon = new SqlConnection();
            ...
            try
            {
                ...
                SqlCommand Command = new SqlCommand();
                Command.Connection = SqlCon;
                Command.CommandText = "speditar_profesor";
                Command.CommandType = CommandType.StoredProcedure;
                ...
                ParametroIdProfesor.ParameterName = "@idprofesor";
                ParametroIdProfesor.SqlDbType = SqlDbType.Int;
                ParametroIdProfesor.Value = Profesor.IdProfesor;
                Command.Parameters.Add(ParametroIdProfesor);
            ...
            {
                Respuesta = ex.Message + ex.StackTrace + " Editar CapaDatos Profesor.";
            }
            finally
            {
                if (SqlCon.State == ConnectionState.Open) SqlCon.Close();
        ...
        //Metodos Eliminar
        public string Eliminar(DatosProfesor Profesor)
        {
            string Respuesta = "";
            SqlConnection SqlCon = new SqlConnection();
            ...
            try
            {
                ...
                SqlCommand Command = new SqlCommand();
                Command.Connection = SqlCon;
                Command.CommandText = "speliminar_profesor";
                Command.CommandType = CommandType.StoredProcedure;

                SqlParameter ParametroIdAdministrativo = new SqlParameter();
                ParametroIdAdministrativo.ParameterName = "@idprofesor";
                ParametroIdAdministrativo.SqlDbType = SqlDbType.Int;
                ParametroIdAdministrativo.Value = Profesor.IdProfesor;
            ...
            {
                Respuesta = ex.Message + ex.StackTrace + " Eliminar CapaDatos Profesor.";
            }
            finally
            {
        ...
        {
            DataTable DataTableResultado = new DataTable("Profesor");
            SqlConnection SqlCon = new SqlConnection();
            ...
            try
            {
                ...
                SqlCommand Command = new SqlCommand();
                Command.Connection = SqlCon;
                Command.CommandText = "spmostrar_profesor";
                Command.CommandType = CommandType.StoredProcedure;
        ...
        //Metodos Nombre
        public DataTable BuscarNombre(DatosProfesor Profesor)
        {
            DataTable DataTableResult = new DataTable("Profesor");
            SqlConnection SqlCon = new SqlConnection();
            ...
            try
            {
                ...
                SqlCommand Command = new SqlCommand();
                Command.Connection = SqlCon;
                Command.CommandText = "spbuscarnombre_profesor";
                Command.CommandType = CommandType.StoredProcedure;
                ...
                ParametroTextoBuscar.Value = Profesor.TextoBuscar;
        ...
        //Metodos Cedula
        public DataTable BuscarCedula(DatosProfesor Profesor)
        {
            DataTable DataTableResult = new DataTable("Profesor");
            SqlConnection SqlCon = new SqlConnection();
            ...
            try
            {
                ...
                SqlCommand Command = new SqlCommand();
                Command.Connection = SqlCon;
                Command.CommandText = "spbuscarcedula_profesor";
                Command.CommandType = CommandType.StoredProcedure;
